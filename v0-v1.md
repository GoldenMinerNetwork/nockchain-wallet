This tutorial explains how to **transfer from a v0 address to another v1 address**. If you need to transfer from a v1 address to a v1 address, please refer to:
[v1-v1](https://github.com/GoldenMinerNetwork/nockchain-wallet/blob/main/v1-v1.md)
